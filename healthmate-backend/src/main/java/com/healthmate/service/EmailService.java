...
public class EmailService {
    ...
    public void sendOtpEmail(String toEmail, String otp, String type) throws MessagingException {
        System.out.println("DEBUG: [EmailService] Attempting to send OTP to: " + toEmail);
        ...
        try {
            ...
            String htmlContent = String.format(
                    "<div style='font-family: Arial, sans-serif; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px; max-width: 500px; margin: 0 auto;'>"
                            ...
                            + "<p style='font-size: 14px; color: #ef4444; text-align: center;'>This OTP expires in <strong>5 minutes</strong>.</p>"
            ...
            System.out.println("DEBUG: [EmailService] SUCCESS: Email sent to " + toEmail);
            
        } catch (Exception e) {
            System.err.println("DEBUG: [EmailService] ERROR: Failed to send email to " + toEmail);
            e.printStackTrace();
